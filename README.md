...
Safely landing means one have to pay attention to the X and Y velocities as well as the better landing location.
...
* SDL2_image >= 2.0
  * This is needed for the rendering of the sprite of the lander
